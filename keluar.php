...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">SATELIT</a>
            <!-- Sidebar Toggle-->
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <a href="exportBKeluar.php" class="btn btn-info">Export Data</a>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    if(isset($_POST['filter_tgl'])){
                                        ...
                                        if($mulai!=null || $selesai!=null){
                                            ...
                                            $ambilsemuadatastok = mysqli_query($conn,"select * from keluar k, stok s where s.idbarang = 
                                            k.idbarang and tanggal BETWEEN '$mulai' and DATE_ADD('$selesai', INTERVAL 1 DAY)");
                                        } else {
